...
############################################################################04.04 위 수정 x
    ...
    # 파일 이름 포맷
    prefix = f"{time_now}_{fingerprint_type}_dt"
    ...
    for p in tqdm(range(len(params))):
        ...
        for train_idx, val_idx in kf.split(x_train, y_train):
            ...
            model = DecisionTreeClassifier(random_state=random_seed, **params[p])
    ...
    final_model = DecisionTreeClassifier(random_state=random_seed, **best_model)
