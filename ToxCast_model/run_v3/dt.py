...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train DecisionTree for ToxCast v3")
    ...
    parser.add_argument("--assay_name", help="Assay column to train on")
...
def build_model(params: dict, random_state: int) -> DecisionTreeClassifier:
