...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train GradientBoosting for ToxCast v3")
...
def build_model(params: dict, random_state: int) -> GradientBoostingClassifier:
